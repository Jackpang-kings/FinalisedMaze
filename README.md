...
| 3.2         | Game Mechanics             | Implement a "Game Over" condition when the player loses all health.  | The game should display a defeat message and end when the player's health reaches 0.             |
...
| 4.6         | Maze Generation Difficulty | Beginner                                                             | 9x9 Depth-first maze                                                                             |
| 4.7         | Maze Generation Difficulty | Easy                                                                 | 15x15 Depth-first maze                                                                           |
| 4.8         | Maze Generation Difficulty | Medium                                                               | 21x21 Prims maze                                                                                 |
...
| 6.1         | Player Initialisation      | Set the player's starting health to 5 hearts.                        | The player's health must be initialized to 5 and displayed in the UI.                            |
| 6.2         | Player Initialisation      | Set the player's inventory capacity to 7 slots.                      | The player can hold up to 7 items at a time, and the UI must reflect this limit.                 |
